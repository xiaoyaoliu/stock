...
"""
    ...
    (select ts_code, (total_assets - total_liab) as ledger_asset from ts_pro_balancesheet where end_date = "20181231" and total_assets > 4010001000 and
        ...
        ts_code in (
            select ts_code from ts_pro_fina_indicator where end_date > 20140101 and end_date < 20190101 and end_date like "%%1231" and roe>15 group by ts_code and having count(distinct year(end_date)) >= 5 and
            ts_code in (
